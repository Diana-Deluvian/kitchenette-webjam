...
const About = () => {
    return (
        <div className="max-w-screen-lg">
            ...
            <p className="my-4">Hi, and welcome to my little kitchenette! This is just a small collection 
            ...
            <p className="my-4">This project was built with React and Tailwind on the frontend, and NodeJS
            and Express on the backend. The data is stored on a MongoDB Atlas, and images are stored 
            on Cloudinary. </p>
            <span className="text-primary text-center mx-auto block text-3xl">♥</span>
            <p className="my-4">If you're ever visiting my home or something similar, you
