...
const Recipes = () => {
  ...
  return (
    <div id='recipes-container' className='flex items-center flex-col'>
      <h1 className='p-2 mt-4 font-emilysCandy text-center text-primary text-6xl'>
        Diana's Kitchenette
      </h1>
      <Search />
      {isLoading ? (
        ...
        <div
          className='mt-8 grid grid-cols-1 md:grid-cols-3 md:mx-4 lg:mx-0 lg:max-w-screen-md 
